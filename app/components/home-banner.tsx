...
const HomeBanner = () => {
  return (
    <div className='w-full px-4 py-2 text-center rounded-base bg-main border-2 border-black shadow-light'>
      ...
      <p>If you want to see the source code then it can be viewed <a href="https://github.com/ThatsOurJake/advent-cal-2024" className='text-black hover:underline' target='_blank'>here.</a></p>
